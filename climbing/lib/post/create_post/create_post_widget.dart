...
class _CreatePostWidgetState extends State<CreatePostWidget> {
  ...
  if (file.bytes != null) {
    ...
    if (tags.isNotEmpty) {
      ...
      print(gpsImgDirectionTag);

      if (gpsImgDirectionTag != null) {
        final directionValue = gpsImgDirectionTag.printable;
        print('GPSImgDirection printable value: $directionValue');
        ...
        if (directionValue.contains('/')) {
          ...
          if (parts.length == 2) {
            ...
            if (numerator != null && denominator != null && denominator != 0) {
              ...
              print("Failed to parse numerator or denominator");
            }
          } else {
            print("Unexpected format for GPSImgDirection value");
          }
        } else {
        ...
        print('Parsed GPSImgDirection value: $gpsImgDirect');
        return gpsImgDirect;
      } else {
        print("No GPSImgDirection tag found");
        return null;
      }
    } else {
