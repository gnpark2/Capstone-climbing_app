...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const NavBarPage() : const SignInAndUpWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => OtherUserProfileWidget(
            userss: params.getParam(
              'userss',
              ParamType.Document,
            ),
            chatsss: params.getParam(
              'chatsss',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: 'followers',
          path: '/followers',
          builder: (context, params) => const FollowersWidget(),
        ),
        FFRoute(
          name: 'following',
          path: '/following',
          builder: (context, params) => const FollowingWidget(),
        ),
        FFRoute(
          name: 'postDetail',
          path: '/postDetail',
        ...
        FFRoute(
          ...
          path: '/newfeed',
          asyncParams: {
            'postdetail': getDoc(['users', 'post'], PostRecord.fromSnapshot),
          },
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'newfeed')
              : NewfeedWidget(
        ...
        FFRoute(
          name: 'postDetailUserEdit',
          path: '/postDetailUserEdit',
          asyncParams: {
            'postdet': getDoc(['users', 'post'], PostRecord.fromSnapshot),
          },
          builder: (context, params) => PostDetailUserEditWidget(
            postdet: params.getParam(
              'postdet',
              ParamType.Document,
            ),
        ...
        FFRoute(
          name: 'savePost',
          path: '/savePost',
          builder: (context, params) => const SavePostWidget(),
        ),
        FFRoute(
          name: 'deleteAccount',
          path: '/deleteAccount',
